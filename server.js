...
// ═══════════════════════════════════════════════════════════════════════════
// ROUTERS — extracted route groups under src/routes/
// ═══════════════════════════════════════════════════════════════════════════
app.use(require('./src/routes/health'));
app.use(require('./src/routes/admin-management'));
app.use(require('./src/routes/teacher-notifications'));
app.use(require('./src/routes/ai-chat'));
app.use(require('./src/routes/daily-quote'));
app.use(require('./src/routes/games'));
app.use(require('./src/routes/leaderboard-extra'));
app.use(require('./src/routes/student-achievements'));
app.use(require('./src/routes/notifications'));
app.use(require('./src/routes/uneb-projects'));
app.use(require('./src/routes/teams'));
